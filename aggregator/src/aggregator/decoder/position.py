"""
Position information in ADS-B messages is ambiguous and has to be combined with other messages to get a definitive
location. The PositionDisambiguator class maintains all the state necessary to disambiguate position information as
